export default function Downvote() {
    return (
        <svg width="19px" height="19px" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="cursor-pointer stroke-neutral-100 hover:stroke-neutral-300 transition" strokeWidth="2">
